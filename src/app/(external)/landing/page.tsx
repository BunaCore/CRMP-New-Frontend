    ...
    <div className="min-h-screen overflow-x-hidden bg-[#fafbfc] font-sans">
      ...
      <header className="container mx-auto flex h-20 items-center justify-between px-6 lg:px-12 xl:max-w-6xl">
        ...
        <nav className="hidden items-center space-x-8 md:flex">
          <Link href="#" className="border-[#eab308] border-b-[2px] pb-1 font-bold text-[#1b2b5a] text-[14px]">
            Research
          </Link>
      ...
      <main className="container mx-auto grid items-center gap-10 px-6 py-12 lg:grid-cols-2 lg:gap-14 lg:px-12 lg:py-16 xl:max-w-6xl">
        ...
        <div className="max-w-lg">
          ...
          <p className="mb-8 max-w-[440px] font-light text-[1rem] text-slate-600 leading-[1.6]">
        ...
        <div className="relative mt-10 flex justify-center lg:mt-0 lg:justify-end">
          ...
          <div className="-top-3 lg:-right-1 absolute right-2 z-20 flex h-14 w-14 items-center justify-center rounded-[12px] border-[#fafbfc] border-[3px] bg-[#fadd96] shadow-lg">
              ...
              <Card className="rounded-lg border-none bg-white/95 px-4 pt-4 pb-3 shadow-2xl backdrop-blur-md">
                <div className="flex items-start gap-3.5">
                  ...
                  <div className="w-full flex-1 overflow-hidden">
                    <p className="mb-0.5 font-bold text-[8px] text-slate-500 uppercase tracking-[0.1em]">
                      Active Projects
                    </p>
      ...
      <section className="bg-[#f0f2f5] py-20">
        <div className="container mx-auto px-6 lg:px-12 xl:max-w-6xl">
          ...
          <div className="mb-12 flex flex-col justify-between gap-8 md:flex-row md:items-end">
            ...
            <div className="pb-2">
              <span className="border-[#a07a10] border-b-[2px] pb-1 font-bold text-[#a07a10] text-[10px] uppercase tracking-[0.2em]">
                INNOVATION CORE
              </span>
            </div>
          </div>
            ...
            <Card className="flex min-h-[200px] flex-col justify-center rounded-2xl border-none bg-white p-8 shadow-sm md:col-span-2 lg:p-10">
              <div className="flex h-full w-full flex-col items-center justify-between gap-6 md:flex-row">
                ...
                <div className="-space-x-2 flex md:pr-4">
                  <div className="z-10 flex h-9 w-9 items-center justify-center rounded-full border-[2px] border-white bg-[#e2e8f0] font-bold text-[#334155] text-[9px] shadow-sm">
                    DR
                  </div>
                  <div className="z-20 flex h-9 w-9 items-center justify-center rounded-full border-[2px] border-white bg-[#cbd5e1] font-bold text-[#334155] text-[9px] shadow-sm">
                    AK
                  </div>
                  <div className="z-30 flex h-9 w-9 items-center justify-center rounded-full border-[2px] border-white bg-[#8c6716] font-bold text-[9px] text-white shadow-sm">
                    +12
                  </div>
                </div>
              </div>
      ...
      <section className="bg-white px-6 py-20 lg:px-12">
        <div className="container mx-auto xl:max-w-6xl">
          <Card className="relative flex flex-col items-center justify-between gap-10 overflow-hidden rounded-[32px] border-none bg-[#031c44] px-10 py-16 text-center shadow-xl lg:flex-row lg:px-16 lg:py-20 lg:text-left">
            <div className="-mr-32 -mt-32 pointer-events-none absolute top-0 right-0 h-[400px] w-[400px] rounded-full bg-blue-500/5" />
        ...
        <div className="container mx-auto px-6 lg:px-12 xl:max-w-6xl">
          <div className="mb-16 grid grid-cols-1 gap-10 md:grid-cols-4">
            <div>
              ...
              <p className="max-w-[220px] text-[13px] text-slate-500 leading-relaxed">
