import type { ApprovalStep, Evaluator, Proposal } from "../types";
...
export const PROPOSALS_INITIAL: Proposal[] = [
  {
    ...
    abstract:
      "This proposal presents a novel convolutional neural network architecture trained on microscopy slide images for the automated detection of Plasmodium falciparum, targeting deployment in low-resource clinical settings.",
    lastAction: "Assigned to evaluator on Mar 14",
    teamCount: 4,
  },
  {
    id: "PRP-2024-002",
    ...
    advisors: [],
    abstract:
      "A feasibility and implementation study for integrating solar PV and wind turbines into micro-grids, optimized for rural communities in the Amhara and Oromia regions.",
    lastAction: "Submitted by PI on Mar 18",
    teamCount: 3,
  },
  {
    id: "PRP-2024-003",
    ...
    advisors: ["Dr. Y. Hailu"],
    abstract:
      "Identifying novel SNP markers associated with Type-2 Diabetes in a population-specific Ethiopian cohort using GWAS and bioinformatics pipeline analysis.",
    lastAction: "Returned for revision: budget justification missing",
    teamCount: 2,
  },
  {
    id: "PRP-2024-004",
    ...
    advisors: [],
    abstract:
      "Application of variational quantum eigensolver (VQE) and QAOA algorithms to NP-hard logistics optimization problems, benchmarked against classical solvers.",
    lastAction: "Evaluation in progress",
    teamCount: 5,
  },
  {
    id: "PRP-2024-005",
    ...
    abstract:
      "Synthesis and in-vitro characterization of lipid nanoparticle carriers for targeted delivery of cisplatin to HeLa cell lines, with focus on reduced systemic toxicity.",
    lastAction: "Submitted by PI on Mar 21",
    teamCount: 6,
  },
  {
    id: "PRP-2024-006",
    ...
    advisors: [],
    abstract:
      "A reinforcement learning-based adaptive traffic signal controller trained on real-world sensor data from Addis Ababa's inner ring road intersections.",
    lastAction: "Draft saved by PI on Mar 10",
    teamCount: 2,
  },
];
