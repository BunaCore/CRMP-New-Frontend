  ...
  "room-1": [
    {
      ...
      content:
        "Good morning everyone! I wanted to discuss the progress on the research platform. How are things going?",
    ...
    },
    {
      ...
      content:
        "Good morning Dr. Tsedniya! The frontend development is progressing well. We have completed the dashboard and team management modules.",
    ...
    },
    {
      ...
      content:
        "The database schema is finalized and I have set up the API endpoints. Backend is ready for integration testing.",
    ...
    },
    {
      ...
      content:
        "Excellent progress! I have been reviewing the research documentation module requirements. We should ensure it supports multiple citation formats.",
    ...
    },
    {
      ...
      content:
        "I have configured the CI/CD pipeline. All deployments are now automated and we have staging and production environments ready.",
    ...
    },
    {
      ...
      senderName: "Dr. Tsedniya Frezewed",
      content:
        "Great work team! Let us schedule a demo for next week. @Betelhem can you coordinate with everyone for availability?",
    ...
    },
    {
      ...
      senderName: "Betelhem Tekle",
      content:
        "Of course! I will send out a poll for available times. Also, Dagimawi has been working on some new UI improvements.",
  ...
  "room-3": [
    {
      ...
      senderName: "Dr. Tsedniya Frezewed",
      content:
        "I have reviewed the latest research methodology proposal. We need to strengthen the literature review section.",
...
export const directMessages: Record<string, GroupChatMessage[]> = {
  "dm-1-2": [
    ...
    },
    {
      ...
      senderName: "Dr. Tsedniya Frezewed",
      content:
        "I was thinking we might need to extend the deadline for the user authentication module. The requirements have grown more complex.",
  ...
  "dm-2-4": [
    ...
    },
    {
      ...
      senderName: "Dagimawi Negusse",
      content:
        "Thanks! I tried to make it more consistent with the university branding. Let me know if you have any feedback.",
      timestamp: new Date(Date.now() - 5 * 3600000).toISOString(),
      isRead: true,
      readBy: ["2", "4"],
    },
